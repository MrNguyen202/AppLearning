  ...
  return (
    <View className="bg-[#F5F9FF]">
      ...
      <View className="justify-evenly items-center h-80">
        ...
        <View className="flex-row items-center w-[360] h-[60]">
          <TouchableOpacity>
            <Image source={Icon.check} className="w-5 h-5"></Image>
          </TouchableOpacity>
          <Text className="font-bold ml-3">Agree to Terms & Conditions</Text>
        </View>
