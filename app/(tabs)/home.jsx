    ...
    <View>
      ...
      <ScrollView>
        <View className={"bg-violet-500 m-5 h-44 rounded"}>
          <View>
            <Text className={"text-white uppercase text-base ml-5 mt-6"}>
              Project management
            </Text>
            <Text
              className={"text-3xl text-white uppercase font-bold ml-5 mt-2"}
            >
              20% off
            </Text>
            <TouchableOpacity
              className={
                "bg-[#00BDD6] h-10 w-28 rounded justify-center items-center ml-5 mt-2"
              }
            >
              <Text className={"uppercase text-white font-semibold"}>
                join now
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <Image
            ...
            className={"w-28 h-40 object-contain absolute right-6 bottom-0"}
          ></Image>
        </View>
